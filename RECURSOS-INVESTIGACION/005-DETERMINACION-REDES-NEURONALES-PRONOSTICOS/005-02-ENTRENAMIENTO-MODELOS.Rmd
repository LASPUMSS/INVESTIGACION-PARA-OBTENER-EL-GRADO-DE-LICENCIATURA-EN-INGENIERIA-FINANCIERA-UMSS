...
Donde X1 y X2 representan los datos de entrada, X1 representa una serie de tiempo con un resago de 1 y X2 igualmente representa una serie de tiempo con un resago estacional, siguiendo la capa oculta esta compuesta con el mismo numero de neuronal que la capa de entrada, así también, dentro lo correspondiente al análisis de los pesos ajustados de una red neuronal estos no pueden ser interpretados más que solo como una tasa de cambio.
...
p1 <- 
    ...
    coord_fixed(ratio = 1/20, xlim = c(0.5, 1))
