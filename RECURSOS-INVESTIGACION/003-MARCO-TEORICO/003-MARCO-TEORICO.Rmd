...
Las finanzas se entiende como "la ciencia y arte de administrar el dinero"
...
Las definiciones presentadas a continuación estan suscriptas a la ley 393 - ley de servicios financieros.

#### Bancos múltiples.

Los bancos múltiples tendrán como objetivo la prestación de servicios financieros al publico en general.

#### Bancos PYME

Los bancos PYME tendrá como objetivo la prestación de servicios financieros especializados en el sector de las pequeñas y medianas empresas, sin restricción para la prestación de los mismos también a la microempresa.


#### Entidades financieras de vivienda

Las entidades financieras de vivienda es una sociedad que tiene por objeto prestar servicios de intermediación financiera con especialización en prestamos para adquisición de vivienda, proyectos de construcción de vivienda unifamiliar o multifamiliar, compra de terrenos, refacción, remodelación, ampliación y mejoramiento de viviendas individuales o propiedad horizontal y otorgamiento de microcredito para vivienda familiar y para infraestructura de vivienda productiva, asi tambien operaciones de arrendamiento financiero habitacional.
...
Este coeficiente mide o tiene por objeto responder en que tanto por ciento esta cubierta los créditos realizados por la institución.
...
Este coeficiente mide si los activos de la institución pueden hacer frente a los gastos administrativos de la institución.
...
Este coeficiente determina el rendimiento en tanto por uno, los beneficios que han generado los activos.
...
```{r, fig.cap='Funciones de activación', out.height='100%', out.width='100%'}
######################################################
...
### Algoritmo de propagacion hacia atras o backpropagation

El algoritmo de backpropagation tiene como objeto minimizar la función de costo ajustando los pesos y sesgos de la red, el nivel de ajuste está determinado por los gradientes de la función de costo con respecto a esos parámetros, es decir que dicho algoritmo dota a la red la capacidad de aprender o encontrar patrones en el conjunto de datos.

Dada un función de costo:

$$ C = f(\bar{Y},Y) $$

Se calcula las derivadas parciales para cada neurona, para determinar que rutas que han generado menor error.
