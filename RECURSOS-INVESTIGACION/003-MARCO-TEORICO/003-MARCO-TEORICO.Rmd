...
```{r}
source('../R/plot-activation-function.R')
```
...
Para el logro de esta derivada se hace uso de un método matemático denominado "Chain Rule", que permite determinar la derivada de una función compuesta, a través de funciones parciales de las funciones que componen la función principal.