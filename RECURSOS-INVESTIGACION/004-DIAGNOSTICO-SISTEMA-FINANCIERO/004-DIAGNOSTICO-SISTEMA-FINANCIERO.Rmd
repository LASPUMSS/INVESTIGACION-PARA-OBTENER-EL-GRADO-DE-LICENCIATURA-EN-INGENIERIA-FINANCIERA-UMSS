...
getTableTrendInd(datTrendInd, 
                 captionTable ='Tendencia indicadores de capital (CAMEL)',
                 idsDecreasing = FALSE)
```
...
datTrendInd <- getDatTrendInd(id, datCamelCalificacionEntidad)
getTableTrendInd(datTrendInd, 
                 captionTable ='Tendencia indicadores de activos (CAMEL)',
                 idsDecreasing = FALSE)
```
...
datTrendInd <- getDatTrendInd(id, datCamelCalificacionEntidad)
getTableTrendInd(datTrendInd, 
                 captionTable ='Tendencia indicadores de administración (CAMEL)',
                 idsDecreasing = FALSE)
```
...
datTrendInd <- getDatTrendInd(id, datCamelCalificacionEntidad)
getTableTrendInd(datTrendInd, 
                 captionTable ='Tendencia indicadores de beneficios (CAMEL)',
                 idsDecreasing = FALSE)
```
...
datTrendInd <- getDatTrendInd(id, datCamelCalificacionEntidad)
getTableTrendInd(datTrendInd, 
                 captionTable ='Tendencia indicadores de liquidez (CAMEL)',
                 idsDecreasing = FALSE)
```
