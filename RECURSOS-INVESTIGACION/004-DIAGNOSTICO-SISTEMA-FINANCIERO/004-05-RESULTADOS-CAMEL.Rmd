...
A continuación, se presentan los resultados CAMEL con rangos flexibles sin ponderar agrupados por tipo de indicador se presentan a continuación (ver tabla \@ref(tab:df-camel-rangos-flexibles-tabla)) (Ver tabla \@ref(tab:df-camel-rangos-estrictos-tabla)):
