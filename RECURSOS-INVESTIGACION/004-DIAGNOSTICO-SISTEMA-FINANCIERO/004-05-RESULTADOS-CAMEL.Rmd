...
```{r}
renderTableBasic(datTrendInd,captionTable = 'Tendencia indicadores de capital (CAMEL)',fontSize = 6.5)
```
...
```{r}
renderTableBasic(datTrendInd,captionTable = 'Tendencia indicadores de activos (CAMEL)',fontSize = 6.5)
```
...
```{r}
renderTableBasic(datTrendInd,captionTable = 'Tendencia indicadores de administración (CAMEL)',fontSize = 6.5)
```
...
```{r}
renderTableBasic(datTrendInd,captionTable = 'Tendencia indicadores de beneficios o rendimiento (CAMEL)',fontSize = 6.5)
```
...
```{r}
renderTableBasic(datTrendInd,captionTable = 'Tendencia indicadores de liquidez (CAMEL)',fontSize = 6.5)
```
...
```{r}
renderTableBasic(datTrendInd,captionTable = 'Tendencia CAMEL por tipo de entidad',fontSize = 6.5)
```
