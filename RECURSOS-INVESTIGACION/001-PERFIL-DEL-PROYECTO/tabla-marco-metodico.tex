...
\textbf{\begin{tabular}[c]{@{}c@{}}Objetivos \\ específicos\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Diagnostico de \\ la situación actual \\ del sistema \\ financiero de \\ Bolivia.\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Definir la \\ arquitectura y \\ entrenamiento \\ del modelo \\ de red de \\ neuronas \\ artificiales\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Proyección y  \\ simulación \\ de estados \\ financieros.\end{tabular}} & \begin{tabular}[c]{@{}c@{}}Evaluación \\ financiera \\ sobre estados \\ financieros \\ proyectados-\\ simulados.\end{tabular} \\ \hline
